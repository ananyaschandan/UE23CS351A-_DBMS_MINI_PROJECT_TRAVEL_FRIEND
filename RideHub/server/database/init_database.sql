-- =====================================================
-- RIDEHUB COMPLETE DATABASE - CONSOLIDATED VERSION
-- Multi-Modal Transport Booking System with Earnings Tracking
-- Includes: All tables, procedures, triggers, views, and sample data
-- Features: Provider earnings, vehicle details, multi-modal routes
-- =====================================================
